...
#python3 /workspace/bert/data/dataPrep.py --action sharding --dataset books_wiki_en_corpus


# Create HDF5 files Phase 1
#python3 /workspace/bert/data/dataPrep.py --action create_hdf5_files --dataset books_wiki_en_corpus --max_seq_length 128 \
...
python3 /workspace/bert/data/dataPrep.py --action create_hdf5_files --dataset books_wiki_en_corpus --max_seq_length 512 \
