    ...
    if args.action == 'download':
        ...
        if args.dataset == 'bookscorpus' or 'wikicorpus' in args.dataset or 'books_wiki' in args.dataset:
            ...
            for _dir in ['train', 'test']:
                ...
                command = 'mv ' + absolute_dir + '/*' + _dir + '*' + ' ' + absolute_dir + '/' + _dir
        ...
        for _dir in ['train', 'test']:
            electra_preprocessing_command = 'python /workspace/electra/create_pretraining_data.py'
            ...
            electra_preprocessing_command += ' --num-out-files=2048'
